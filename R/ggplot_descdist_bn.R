...
ggplot_descdist_bn <- function(bn, node, boot = 1000, obs.col = "darkblue", boot.col = "orange",
                               title = "Cullen and Frey graph", subtitle = node,
  ...
  data <- data$posterior
  ggplot_descdist(data = data,boot = boot, obs.col = obs.col, boot.col = boot.col,
